...
- Javascript classes、comonents are declared with PascalCase ; javascript variables、objects、array、functions are declared with camelCase .
...
## Regular expression
* Delimiters : slashes `//` are used as delimiters in Regex
* Wildcard `.` matches any **single character** except \n
* `\s` (lowercase s ) matches a whitespace (blank, tab \t , and newline \r or \n ) ; `\S` (uppercase S ) matches non-whitespace
