...
- **Stop consonant to any other consonant linking** : Don’t release the first stop consonant,a brief stop is used to signal the final consonant of the first word  
eg. Cold tomorrow
